...
import { useSettings, useCategories, usePackages, useGallery, useTestimonials } from "@/lib/hooks";
  ...
  return (
    <div className="bg-background">
      ...
      {testimonials.length > 0 && (
        <section className="section-divider border-t border-[#202020] bg-soft py-16 sm:py-24" aria-labelledby="testimonials-heading">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
